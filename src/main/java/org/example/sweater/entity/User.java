...
@Entity
@Table(name = "usr") // хранится в таблице "usr"
public class User implements UserDetails {
    ...
    /* 1. Используя аннотацию @ElementCollection - чтобы не создавать таблицу для енама ролей.
       ...
       3. @CollectionTable(name = "user_role", joinColumns = @JoinColumn(name = "user_id")) - для создания таблицы
       ролей юзеров "user_role", которая будет соединяться с текущей табл по внешн ключу user_id
          */
